package com.soict.hoangviet.procoroutines.custom;
...
//        int colorHint = a.getColor(R.styleable.ClearableEditText_android_textColorHint, R.color.md_white_1000);
//        if(colorHint != -1) {
//        }
        editText.setHintTextColor(ContextCompat.getColor(context,R.color.md_white_1000));
    ...
    public void setHintColor(int hintTextColor) {
